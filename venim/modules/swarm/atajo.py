...
un dato que está escrito en `venim/data/memoria/controles.json` desde hace
...
def consultar(command: str) -> dict | None:
    ...
    try:
        from venim.modules.lilim import responde_si_sabe
        from venim.modules.lilim.mielina import clasificar_intencion_local
